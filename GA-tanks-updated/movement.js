...
function movement2(tank, parameters) {
  ...
  let w1 = parameters[1]*sensorsData[0] + parameters[2]*sensorsData[0]**2 + parameters[3]*sensorsData[0]**3 +
           parameters[4]*sensorsData[1] + parameters[5]*sensorsData[1]**2 + parameters[6]*sensorsData[1]**3 + 
           parameters[7]*sensorsData[2] + parameters[8]*sensorsData[2]**2 + parameters[9]*sensorsData[2]**3 +
           parameters[10]*sensorsData[3] + parameters[11]*sensorsData[3]**2 + parameters[12]*sensorsData[3]**3;

  let w2 = parameters[13]*sensorsData[0] + parameters[14]*sensorsData[0]**2 + parameters[15]*sensorsData[0]**3 +
           parameters[16]*sensorsData[1] + parameters[17]*sensorsData[1]**2 + parameters[18]*sensorsData[1]**3 +
           parameters[19]*sensorsData[2] + parameters[20]*sensorsData[2]**2 + parameters[21]*sensorsData[2]**3 +
		   parameters[22]*sensorsData[3] + parameters[23]*sensorsData[3]**2 + parameters[0]*sensorsData[3]**3;
